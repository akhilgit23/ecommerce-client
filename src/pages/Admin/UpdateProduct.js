...
const UpdateProduct = () => {
  ...
  const handleUpdate = async (e) =>{
    ...
    try{
      ...
      const { data } = api.put(`/api/v1/product/update-product/${id}`,productData);
      if(data?.success){
          ...
          <div className='mb-3'>
            {photo ? (
              <div className='text-center'>
                ...
                <div className='text-center'>
                <img src={`https://ecommerce-server-coral-two.vercel.app/api/v1/product/product-photo/${id}`} alt='product_photo'
                 height={'200px'} className='img img-responsive' />
              </div>
            )}
          </div>
